...
//        mMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(this,R.raw.style_json));
        ...
        mMap.addMarker(place1).setIcon(BitmapDescriptorFactory.fromResource(R.mipmap.pin));
        mMap.addMarker(place2).setIcon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED));
...
//        Toast.makeText(this, msg, Toast.LENGTH_SHORT).show();
        ...
        if(isFirstTime){
            ...
            place2 = new MarkerOptions().position(new LatLng(ulat,ulng)).title("Vadafone Store");
